var request = {
    ...
    url: {
        ...
        'queryByOpenId': baseUrl + '/wechatUser/queryByOpenId', //查询用户是否已经绑定
        'queryCountDrawByOpenId': baseUrl + '/wechatUser/queryCountDrawByOpenId', //根据openId 查询抽奖次数
        'bindMobile': baseUrl + '/wechatUser/bindMobile', //根据openId 查询抽奖次数
        'addLotteryCount': baseUrl + '/wechatUser/addLotteryCount', //增加抽奖次数
        'luckDraw': baseUrl + '/prizeRecord/luckDraw', //抽奖
        'prizeRecord': baseUrl + '/prizeRecord/page', //抽奖查询
        'claimPrize': baseUrl + '/prizeRecord/claimPrize', //领取
    },
    code: {
        ok: 1000
    },
...
function wxConfig(params, showMenu) {
    ...
    wx.error(function(res) {
        // alert('柴玲测试--错误信息：' + JSON.stringify(res));
        // alert('柴玲测试--分享配置的信息看看有没有:' + JSON.stringify(request.shareConfig));
        // alert('柴玲测试--验证的信息看看有没有:' + JSON.stringify(shareData));
    });

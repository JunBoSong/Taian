...
Layer.prototype.view = function(){
  ...
  //标题区域背景图--shengchuang
  var titleImg = (function(){ //传入的是图片路径
    return config.titleImg
    ? '<img src="' + config.titleImg + '" class="sean-title-img" alt="标题背景"/>'
    : '';
  }());
...
Layer.prototype.action = function(config, elem){
  ...
  //点底部关闭按钮关闭--shengchuang
  if(config.shade){
    var closeBtn = elem[claname]('sean-close')[0];
